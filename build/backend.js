...
(function (___scope___) {
   ...
   realm.module("realm.router.Dispatcher", ["realm.router.Collection", "realm.router.Decoration", "realm.router.Traceback", "realm.router.RequestInjectors", "realm.router.utils.path2exp", "realm.router.utils.Promise", "realm.router.utils.logger", "realm.router.utils.lodash"], function (Collection, Decoration, Traceback, RequestInjectors, path2exp, Promise, logger, _) {
      ...
      var Dispatcher = function (_Decoration) {
         _inherits(Dispatcher, _Decoration);
         ...
         _createClass(Dispatcher, [{
            ...
            key: "invoke",
            value: function invoke(item, opts) {
               opts = opts || {};
   ...
   realm.module("realm.router.test.MainRouter", ["realm.router.decorators.route", "realm.router.decorators.cors", "realm.router.test.Session"], function (route, cors, sess) {
      ...
      var MainRouter = (_dec = route("/test/:id/:lang?"), _dec(_class = function () {
         function MainRouter() {
   ...
   realm.module("realm.router.test.MyFirstBridge", ["realm.router.test.Permissions"], function (permissions) {
      ...
      var MyFirstBridge = (_dec2 = permissions(), (_class2 = function () {
         function MyFirstBridge() {
            _classCallCheck(this, MyFirstBridge);
         }

         _createClass(MyFirstBridge, null, [{
            key: "getSomething",
            value: function getSomething(id) {
               return {
         ...
         return MyFirstBridge;
      }(), (_applyDecoratedDescriptor(_class2, "getSomething", [_dec2], Object.getOwnPropertyDescriptor(_class2, "getSomething"), _class2)), _class2));
   ...
   realm.module("realm.router.test.Session", ["realm.router.Decorator", "realm.router.test.Permissions"], function (Decorator, permissions) {
       ...
       * Session
       */
      var Session = (_dec3 = permissions(), _dec3(_class3 = function () {
         function Session() {
   ...
   realm.module("realm.router.bridge.BridgeExec", ["realm.router.Decoration", "realm.router.Dispatcher", "realm.router.Traceback"], function (Decoration, Dispatcher, Traceback) {
      ...
      var BridgeExec = function (_Decoration2) {
         _inherits(BridgeExec, _Decoration2);

         function BridgeExec(name, method, opts) {
            _classCallCheck(this, BridgeExec);

            var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(BridgeExec).call(this));

            _this2.name = name;
            _this2.method = method;
            _this2.opts = opts || {};
            _this2.args = _this2.opts.args;
            _this2.services = {
               $req: opts.req,
               $res: opts.res
            };
   ...
   realm.module("realm.router.bridge.BridgeRoute", ["realm.router.decorators.route", "realm.router.Dispatcher", "realm.router.bridge.BridgeExec"], function (route, Dispatcher, BridgeExec) {
      ...
      var BridgeRoute = (_dec4 = route("/_realm_/bridge/"), _dec4(_class4 = function () {
         function BridgeRoute() {
            _classCallCheck(this, BridgeRoute);
         }

         _createClass(BridgeRoute, null, [{
            key: "post",
            value: function post($body, $req, $res, $params) {
